        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Luxury living with breathtaking Red Rock views, world-class golf courses, and premier amenities in Las Vegas's most prestigious community
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Summerlin West represents the pinnacle of luxury living in Las Vegas, offering residents unparalleled access to natural beauty, recreational amenities, and sophisticated lifestyle options.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Breathtaking views of Red Rock Canyon National Conservation Area
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Wake up to stunning mountain vistas and enjoy world-class hiking trails just minutes from your doorstep.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Play on championship courses designed by renowned architects, including TPC Summerlin and Red Rock Country Club.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Enjoy luxury shopping at Downtown Summerlin and nearby premium retail centers with top-tier restaurants.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Experience the finest in luxury living with world-class amenities and services
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Championship golf course with stunning mountain views</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Resort-Style Pools</h4>
                    <p className="text-gray-600">Multiple pools with cabanas and poolside service</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Tennis & Pickleball</h4>
                    <p className="text-gray-600">Professional courts with instruction available</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-gray-600">Direct access to Red Rock Canyon trails</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Fitness Centers</h4>
                    <p className="text-gray-600">State-of-the-art equipment and personal training</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <MapPin className="w-5 h-5 text-primary-600 mr-3" />
                  <span className="text-gray-700">Downtown Summerlin - 10 minutes</span>
                </div>
                <div className="flex items-center">
                  <MapPin className="w-5 h-5 text-primary-600 mr-3" />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              From elegant single-family homes to luxury estates, find your perfect Summerlin West residence
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Summerlin Specialist</h4>
                    <p className="text-gray-600">Deep knowledge of Summerlin West communities and market trends</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-gray-600">Specialized in high-end properties and luxury amenities</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-gray-600">Exclusive access to new construction and off-market properties</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-blue-50 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Hundreds of satisfied clients</span>
                </div>
                <div className="flex items-center">
