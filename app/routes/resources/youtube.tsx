...
export function links() {
  return [
    { rel: "canonical", href: `${config.seo.siteUrl}/resources/youtube` },
  ];
}
...
export function meta() {
  return [
    ...
    { name: "description", content: "Dr. Jan Duffy's YouTube channel with Las Vegas real estate videos and market updates." },
